    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FDFCF9] dark:bg-dark-bg transition-colors duration-500 p-6">
      <div className="max-w-xl w-full rounded-[40px] border-2 border-dashed border-rose-500/30 bg-rose-500/5 dark:bg-rose-500/10 p-10 md:p-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <button
            onClick={reset}
            className="w-[50px] h-[50px] bg-gourmet-green dark:bg-dark-green rounded-full shadow-xl flex items-center justify-center border-b-4 border-black/20 group transition-colors duration-300 hover:scale-110"
          >
            <div className="w-[42px] h-[42px] rounded-full border-2 border-dashed border-white/10 flex items-center justify-center">
              <RotateCcw className="w-6 h-6 text-gourmet-ink dark:text-dark-text" />
            </div>
          </button>
