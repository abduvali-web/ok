  ...
  const StatItem = ({ label, value, sub, color, dot, icon: Icon }: any) => (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-xs md:text-sm font-black uppercase tracking-widest text-muted-foreground/60">{label}</span>
      </div>
      <div className={cn("text-3xl md:text-5xl font-black tracking-tighter", color)}>{value}</div>
      <p className="text-sm md:text-lg font-bold text-muted-foreground/40 mt-2">{sub}</p>
  ...
  return (
    <TabsContent value="statistics" className="min-h-0">
      ...
      >
        ...
        >
          <PieChart className="w-56 h-56 md:w-64 md:h-64 text-foreground" />
        </motion.div>
        ...
        <div className="space-y-10 md:space-y-14 relative z-10 flex-1 overflow-auto no-scrollbar pb-10">
          ...
          <section>
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              ...
              <h3 className="text-sm md:text-base font-black uppercase tracking-[0.2em] text-foreground">Buyurtmalar holati</h3>
            </div>
          ...
          <section>
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              ...
              <h3 className="text-sm md:text-base font-black uppercase tracking-[0.2em] text-foreground">To'lovlar tahlili</h3>
            </div>
            <div className={cardContainer}>
              <StatItem
          ...
          <section>
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              ...
              <h3 className="text-sm md:text-base font-black uppercase tracking-[0.2em] text-foreground">Mijozlar faolligi</h3>
            </div>
            <div className={cardContainer}>
              <StatItem
          ...
          <section>
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              <Beef className="w-6 h-6 text-foreground" />
              <h3 className="text-sm md:text-base font-black uppercase tracking-[0.2em] text-foreground">Ratsionlar tahlili</h3>
            </div>
