...
export function Sidebar({ className, activeTab, onTabChange, isOpen, onClose, onLogout: _onLogout }: SidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    { id: 'statistics', label: t.admin.statistics || 'Stats', icon: BarChart3, badge: null },
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'md:relative md:translate-x-0 md:w-[136px] md:m-4 md:rounded-[50px] md:bg-white/10 md:dark:bg-white/5 md:border-2 md:border-dashed md:border-white/10 md:p-4 md:shadow-2xl md:self-start md:h-fit',
          ...
          <div className="flex items-center justify-between px-6 py-6 md:hidden">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-lg font-black tracking-tight text-white truncate">AutoFood</p>
                <p className="text-[10px] font-black text-white/40 tracking-[0.2em] uppercase truncate">
              ...
              {menuItems.map((item) => {
                if ('type' in item) {
                  return (
                    <div
                      key={item.id}
                      className="self-stretch my-2 h-[2px] border-t-2 border-dashed border-white/10"
                    />
                  );
                }
                  ...
                  >
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute inset-0 bg-gourmet-green/60 dark:bg-dark-green/60 rounded-[30px] md:rounded-[40px] z-0 shadow-lg border-b-4 border-black/20"
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'bg-white text-gourmet-green shadow-xl'
                    ...
                    >
                        <div className={cn(
                          ...
                          isActive ? 'border-gourmet-green/20' : 'border-white/10'
                        )}>
