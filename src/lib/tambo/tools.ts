...
const SITE_ENDPOINT_CATALOG: Array<{
  ...
  { path: "/api/admin/orders", methods: ["GET"], description: "Orders list" },
  { path: "/api/admin/orders/bulk-update", methods: ["POST"], description: "Bulk update orders" },
  { path: "/api/admin/orders/reorder", methods: ["POST"], description: "Reorder orders" },
